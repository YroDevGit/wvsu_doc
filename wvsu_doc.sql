...
REPLACE INTO `file_viewer` (`id`, `emp_id`, `file_id`, `school`, `device`, `date_viewed`) VALUES
	...
	(21, 1008, 45, 1, 'Windows NT LENOVO-JKCN42WW 10.0 build 22631 (Windows 11) AMD64   \rLENOVO        \r\r Model  \r82TT   \r\r', '2024-08-22 07:09:34'),
...
-- Dumping data for table wvsu.otp_code: ~1 rows (approximately)
REPLACE INTO `otp_code` (`id`, `email_address`, `otp_code`, `stat`, `otp_date`) VALUES
	...
	(17, 'tyronemalocon@gmail.com', '59032', 0, '2024-08-24 03:50:57');

...
<div class="card-box mb-30">
    <div class="pd-20">
        ...
        <h4 class="text-blue h4">Received Documents</h4>
    </div>
    <div class="pb-20">
        <table class="table hover data-table-export nowrap" export="Files">
            ...
            <tbody>
                <?php foreach($this->files_tbl->getRegistryAll() as $col): ?>
                    <tr>
                        <td></td>
...
">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Received Documents</h4>
            ...
            <form action="<?=CONTROLLER()?>File/addRegistry" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <?php INPUT_FIELD("Remarks", "remarks",  "Remarks") ?>
                </div>

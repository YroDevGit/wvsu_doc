			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						...
						<a style="cursor: pointer;display:none;" class="dropdown-item" data-toggle="modal" data-target="#bd-example-modal-lg1222"><i class="icon-copy fa fa-barcode"></i> Login Barcode</a>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<!-- Export Datatable start -->
				 <div>
					<?php CY_VIEW_CONTENT("super/".$content) ?>
				</div>

...
|
| WARNING: If you set this to 'PATH_INFO', URIs will always be URL-decoded!REQUEST_URI
*/
...
|
*/
include_once SYSTEM_DATA."fe_config.php";
...
$config['sess_cookie_name'] = 'CodeYro_Session';

$('document').ready(function(){
	var exportFilename = $('.data-table-export').attr('export') || 'Exported_Data';
	var maxrow = $('.data-table-export').attr('maxrow') || 10;
    var ord = $('.data-table-export').attr('ordering') || false;
